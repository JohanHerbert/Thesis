...
As a further test, different weights will be used for the different terms in the loss function during training. This is to see what how big the different terms in the loss function should be in relation to each other. The weights that will be tested for each term is 1, 3, 6. This will test will be conducted on the best performing method from the hyper parameter test. The evaluation of this test will be done by looking at the equally weighted loss to make the comparison fair. This test is performed for the independence copula. 
...
\todo{and time horizon, and mean and volatility}
