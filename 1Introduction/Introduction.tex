...
The history of copulas can be traced back to Frechet \Citet{bibid} as stated by \Citet[p.~1]{DuranteSempi2010}. The term copula was first used by \Citet{Sklar1959} in his work on statistical metric spaces. Later Schweizer introduced the use of copulas to construct dependence measures. Nelsen wrote a book on copulas defining it thoroughly. In 2022 \Citet{NeuralCopula} introduced the \gls{NC} which is a new method of modeling dependence using neural networks. 
