...
\begin{align*}
    ...
    S_0 &= s_0 \in \mathbb{R},
\end{align*}
where $S_t$ is the stock price at time $t$, $\mu \in \mathbb{R}$ is the drift, $\sigma \in \mathbb{R}_+$ is the volatility, and $W_t$ is a Wiener process \citet[p.~67]{Bjork2019Edition4}.\todo{Find page where GBM is defined}
