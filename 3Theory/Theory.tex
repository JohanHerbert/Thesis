...
\begin{align*}
    ...
    S_0 &= s_0, 
\end{align*}
where $S_t$ is the stock price at time $t$, $\mu$ is the drift, $\sigma$ is the volatility, and $W_t$ is a Wiener process \Citet[p.~67]{Bjork2019Edition3} \todo{Version Of Book p70 in latest proposition 5}. The \gls{GBM} can be solved using the Itô formula, which gives the solution
\begin{align*}
