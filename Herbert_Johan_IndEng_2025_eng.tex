...
\begin{center}
    ...
    {%
        ...
        \bfseries 
        \sffamily
        Monte Carlo Simulation for Modeling Financial Dependence Structures
    }%
\end{center}
...
\begin{center}
    \color{white}
    \large
    Examination Date: June 3, 2025 %\today
\end{center}
\vfill
\begin{center}
...
\begin{abstract}
    ...
    \textbf{Keywords:} \textit{Copulas, Neural Networks, Financial Modeling, Financial Time Series, Dependence Modeling, Monte Carlo Simulation, Distribution Fitting, Random Number Generation.}
\end{abstract}
